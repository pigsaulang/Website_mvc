 ...
 <div class="main">
    <div class="content">
    	<div class="section group">
    		...
    		$get_product_deatils = $product->get_details($id);
    		if($get_product_deatils){
    			while($result_details = $get_product_deatils->fetch_assoc()){
		...
		<div class="cont-desc span_1_of_2">				
			...
			<h2>Product Details</h2>
				<?php echo $fm->textShorten($result_details['productDesc'], 150)?>
	    </div>
